package com.example.yolov3_tiny;
    ...
    public void YOLO(View Button){
        ...
        if (startYolo == false){
            ...
            if (firstTimeYolo == false){
                ...
                firstTimeYolo = true;
                String Cfg = Environment.getExternalStorageDirectory().getAbsolutePath() + "/dnns/yolov3-tiny.cfg" ;
                String Weights = Environment.getExternalStorageDirectory() + "/dnns/yolov3-tiny.weights";

                //String Cfg = getPath("yolov3-tiny.cfg",this) ;
                //String Weights = getPath("yolov3-tiny.weights",this);
                tinyYolo = Dnn.readNetFromDarknet(Cfg, Weights);
